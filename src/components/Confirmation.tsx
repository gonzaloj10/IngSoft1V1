    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-card rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="mb-6">
            {emailSent ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center justify-center gap-3 mb-4">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-center justify-center gap-3 mb-4">
